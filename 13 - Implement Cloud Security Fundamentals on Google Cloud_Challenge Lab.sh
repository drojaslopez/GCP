...
echo ""
echo crearte Project ID

gcloud config set project qwiklabs-gcp-01-f47b5fe49c08

 gcloud auth list
 gcloud config list project


export CUSTOM_SECURIY_ROLE=orca_storage_editor_661
export SERVICE_ACCOUNT=orca-private-cluster-385-sa
export CLUSTER_NAME=orca-cluster-573
